...
- [Mock Interview](https://www.mockinterview.co/)
...
![s](images/Judit-photo1_602x433.jpg)
...
- Read: [Queen](https://en.wikipedia.org/wiki/Queen_(chess)), [Backtracking](https://www.geeksforgeeks.org/backtracking-algorithms/)
